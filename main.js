...
document.getElementById("SketchThatHasToBeDrawn").textContent = "Sketch To Be Drawn: " + Sketch;
...
function draw(){
    if(drawn_sketch == Sketch){
        answer_holder = "set";
        score++;
        document.getElementById("ScoreSpan").textContent = "Score: " + score;
    }
...
function check_sketch(){
    timer_counter++;
    document.getElementById("TimeSpan").textContent = "Timer: " + timer_counter;
...
function gotResult(error, results){
    if(error){
        ...
        document.getElementById("UserSketch").innerHTML = "The Sketch You Drew: " + drawn_sketch;
